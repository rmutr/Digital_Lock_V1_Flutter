...
class SQLiteHelper {
  final String nameDatabase = 'matData.db';
  final String tableDatabase = 'matTABLE';
  int version = 1;
  final String idColumn = 'id';
  final String latDatabase = 'latSqlite';
  final String lonDatabase = 'lonSqlite';
  ...
  Future<Null> initDatabase() async {
    await openDatabase(join(await getDatabasesPath(), nameDatabase),
        onCreate: (db, version) => db.execute(
            'CREATE TABLE $tableDatabase ($idColumn INTEGER PRIMARY KEY, $latDatabase TEXT, $lonDatabase TEXT)'),
        version: version);
  }
